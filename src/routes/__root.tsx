...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mr. President — Game Assistant" },
      { name: "description", content: "Mr. President scenario game assistant" },
      { property: "og:title", content: "Mr. President — Game Assistant" },
      { property: "og:description", content: "Mr. President scenario game assistant" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Mr. President — Game Assistant" },
      { name: "twitter:description", content: "Mr. President scenario game assistant" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Vazirmatn:wght@300;400;500;700;900&display=swap" },
      {
        rel: "stylesheet",
        href: appCss,
      },
